...
public class UserRegister extends javax.swing.JInternalFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        for(User user : list){
            if(user.getLogin().equals(this.txtLogin.getText()) || user.getCpf().equals(this.txtCpf.getText()))
                value = 1;
        }
        ...
        if(!this.txtCpf.getText().isEmpty() && !this.txtLogin.getText().isEmpty() && !this.txtName.getText().isEmpty() && !this.txtPassword.getPassword().toString().isEmpty()){
            if(value == 0){
                ...
                JOptionPane.showMessageDialog(null, "This login or CPF already exists!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }else{
